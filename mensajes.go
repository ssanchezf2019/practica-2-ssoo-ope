...
// Mensajes de formato
const (
	msgConectado            = "%s ✈️ Avión %d: Conectado con la torre de control\n"
	msgAterrizando          = "%s 🛬 Avión %d: Aterrizando en pista\n"
	...
	msgTerminoDesembarque   = "%s ✅ Avión %d: Terminó desembarque en %.2f segundos desde aterrizaje\n"
)
